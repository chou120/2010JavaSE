...
import club.banyuan.Gender;
import club.banyuan.UserRefine;
...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    User user1 = new User("赵六", 33, GenderRefine.valueOf("男"));
    System.out.println(user1);

    // 枚举类和字符串互转，使用的是枚举类中对象的名字
    UserGenderEnum userGenderEnum = new UserGenderEnum("王二", 20, GenderEnum.valueOf("FEMALE"));
    System.out.println(userGenderEnum);
    UserGenderEnum userEnum1 = new UserGenderEnum("王二", 20, GenderEnum.valueOfType("男"));
    System.out.println(userEnum1);
  }
}
