...
public class Encode {
  ...
  public static void main(String[] args) {
    ...
    String inputFilePath = decodeFilePath;
    String outputFilePath = encodeFilePath;
    ...
    // Messenger.message(inputFilePath, outputFilePath, true);
    Messenger.message(inputFilePath, outputFilePath, Encode::caesarEncode);
