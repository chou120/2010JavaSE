...
public class HttpServerFormDemo {
    ...
    while (true) {
      ...
      if ("/".equals(url)) {
        ...
        if (resourcePath.endsWith(".html")
            && HttpServerFormDemo.class.getResource(resourcePath) == null) {
    ...
    switch (url) {
      case "/server/user/login":
        ...
        if (loginUser == null) {
          ...
          // 写入 login.html的数据
          // writeStaticResource(outputStream, "/pages/login.html");
  ...
  private static void writeStaticResource(OutputStream outputStream, String resourcePath)
    ...
    BufferedInputStream bufferedInputStream = new BufferedInputStream(
        HttpServerFormDemo.class.getResourceAsStream(resourcePath));
